...
class Adinvestoraccount extends Component {
    ...
    return (
      <div className="animated fadeIn">
        <Row>
          ...
          <Col xs="12" md="6" >
            <p className="font-weight-bold">TÀI KHOẢN ADMIN CỦA CHỦ ĐẦU TƯ</p>
          </Col>
                    ...
                    <Card>
                      <CardBody>
                        <Table responsive>
                          ...
                          <tr>
                            <th>ID</th>
                            <th>Công ty chủ đầu tư<Input bsSize="sm" type="text" id="input-small" name="input-small" className="input-sm" placeholder="Text input" /></th>
                            <th>Họ tên admin<Input bsSize="sm" type="text" id="input-small" name="input-small" className="input-sm" placeholder="Text input" /></th>
                            <th>Số ĐT</th>
                            <th>Email</th>
                            <th>Username</th>
                            <th>Password</th>
...
export default Adinvestoraccount;
