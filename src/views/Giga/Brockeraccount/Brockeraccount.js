...
class Brockeraccount extends Component {
  ...
  render() {
    return (
      <div className="animated fadeIn">
        <Row>
          <Col xs="12" md="6">
            <p className="font-weight-bold">TÀI KHOẢN NHÂN VIÊN MÔI GIỚI</p>
          </Col>
        </Row>
        <Row>
                      ...
                      <CardBody>
                        <Table responsive>
                          ...
                          <tr>
                            ...
                            <th>Họ tên môi giới<Input bsSize="sm" type="text" id="input-small" name="input-small" className="input-sm" placeholder="Text input" /> </th>
                            <th>Số ĐT</th>
                            <th>Email</th>
                            <th>Username</th>
                            <th>Password</th>
