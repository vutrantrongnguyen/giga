            ...
            <CardBody>
              <Table responsive>
                ...
                <tr>
                  ...
                  <th>Xác thực<Input bsSize="sm" type="text" id="input-small" name="input-small" className="input-sm" placeholder="Text input" /></th>
                  <th>Chi tiết</th>
                  <th>Duyệt<Input bsSize="sm" type="text" id="input-small" name="input-small" className="input-sm" placeholder="Text input" /></th>
                </tr>
                </thead>
                <tbody>
                <tr>
                  ...
                  <td>Hiển thị</td>
                  <td>Hiển thị</td>
                  <td><Button onClick={this.togglePrimary} className="mr-1"><a href="/postdetail"><i className="fa fa-eye"></i></a></Button></td>
                  <td>
                  Hiển thị
                  </td>
                </tr>
  ...
  render() {
    return (
      <div className="animated fadeIn">
        <Row> <Col xs="12" md="6" >
          <p className="font-weight-bold">QUẢN LÝ TIN ĐĂNG MỚI</p>
        </Col>
        </Row>
        <Row>
